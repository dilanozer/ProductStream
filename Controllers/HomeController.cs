...
using ProductStream.Web.Models.ViewModels;
using ProductStream.Web.Services;

namespace ProductStream.Web.Controllers;

public class HomeController(
    ILogger<HomeController> logger, UserManager<IdentityUser> userManager, 
    SignInManager<IdentityUser> signInManager, AppDbContext context, FileService fileService) 
        : Controller
{
    ...
    {
        var user = await userManager.FindByEmailAsync("dozer@gmail.com");
